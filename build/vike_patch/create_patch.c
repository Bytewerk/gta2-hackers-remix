...
int main(int argc, char **argv) {
  ...
  printf("writing %s...\n", argv[5]);
  handle = fopen(argv[5], "w");
  fprintf(handle, "// this file gets automatically generated by\n");
  fprintf(handle, "// the Makefile in build/vike_patch\n\n");
  fprintf(handle, "#define G2HR_GTA2_EXE_SIZE %" PRIu32 "\n", size_old);
  fprintf(handle, "#define G2HR_GTA2_EXE_SIZE_PATCHED %" PRIu32 "\n", size_new);
  fclose(handle);
